...
<body class="">
    ...
    <div class="col-sm-2 text-center backendnav" style="margin-top:1.5in; float:left">
      ...
      <p><a href="ProductPage.html">Product List</a></p>
      <p><a href="UserList.html">User List</a></p>
      <p><a href="ordersList.html">Order List</a></p>
    </div>
    <form action = "" method = "POST" id = "addpro" enctype="multipart/form-data">
    <div class="col-sm-7 text-center mt-5" style="float:left;">
      <div class = "row-6-md" style = "margin-top:3cm; min-width: 20%;">
          <h1 style="margin-bottom:1.5cm;">Add Product</h1>
          ...
          <thead id="Tables1H">
              ...
              <tbody>
                ...
                <td class="ppitems"><input type = "text" name = "productname" placeholder = "Product Name" value = "<?php if (isset($_POST['productname'])) echo $_POST['productname']; ?>"style = "width:70%;"></td>
                <td class="ppitems"><input type = "text" name = "productid" placeholder = "Product ID" value = "<?php if (isset($_POST['productid'])) echo $_POST['productid']; ?>" style = "width:70%;"></td>
                <td class="ppitems"><input type = "text" name = "productprice" placeholder = "Product Price" value = "<?php if (isset($_POST['productprice'])) echo $_POST['productprice']; ?>" style = "width:70%;"></td>
                <td class="ppitems"><input type = "text" name = "productqty" placeholder = "Product Quantity" value = "<?php if (isset($_POST['productqty'])) echo $_POST['productqty']; ?>"style = "width:70%;"></td>
              </tr>
    ...
    <div class="col-sm-7 text-center mt-5 m-auto">
        ...
        <textarea name = "description" style = "width: 100%;"><?php echo $_POST['description']?></textarea>
            ...
            <input type="submit" class="btn btn-outline-dark sbutton mt-5" name = "submit" style=" float:right;" value = "Save">
            &nbsp;
