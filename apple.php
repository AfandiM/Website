<?php $page_title='Apple'; include('header.php');
$product_id='#3';
include('product_info.php');
?>      <br><br>
      <div class ="item-description">
        <img src="images/apple-product.jpg">
        <h1>Apple</h1>
        <?php if($sale == "Yes"){
        ...
        ?>
        <p>Aisle: <?php echo $aisle?><br>In Stock:<?php echo $qty?><br>Very Juicy<br>Comes in different sizes and colors</p>
        <button onclick="moreDesc()" class="button button1">More Description</button>
        <div id="moreDesc" style="display: none">
          Farm: Pepperidge Farm<br>Imported From: Quebec, Quebec<br>Expires: 04/25/21<br>Average Size: 5cm<br>Product Number: <?php echo $product_id?><br>Organic
          <br>Calories: 200
        </div>
        <div class="button">
        <form method="POST" action="addToCart.php">
          <input style='display:none' name='name' value='Apple' readonly>
          <input style='display:none' name='id' value='#3' readonly>
