<?php $page_title='Bacon'; include('header.php');
$product_id='#9';
include('product_info.php');
?>
      <br><br>
      <div class ="item-description">
        <img src="images/bacon-product.jpg">
        <h1>Bacon</h1>
        <?php if($sale == "Yes"){
        ...
        ?>
        <p>Aisle: <?php echo $aisle?><br>In Stock:<?php echo $qty?><br>Crispy <br> Comes with 12 slices</p>
        <button onclick="moreDesc()" class="button button1">More Description</button>
        <div id="moreDesc" style="display: none">
          Farm: Animal Farm<br>Imported From: Laval, Quebec<br>Expires: 03/20/21<br>Number in Pack: 12<br>Product Number: <?php echo $product_id?><br>From animals fed with supplements
          <br>Calories: 1200
        </div>
        <div class="button">
        <form method="POST" action="addToCart.php">
          <input style='display:none' name='name' value='Bacon' readonly>
          <input style='display:none' name='id' value='#9' readonly>
          ...
          <br>
          <button onclick="addToCart('Bacon(s)')" class="button button2">Add To Cart</button>
          </form>
        </div>
      </div>
