<?php $page_title='Carrot'; include('header.php');
$product_id='#6';
include('product_info.php');
?>
      <br><br>
      <div class ="item-description">
        <img src="images/carrot-product.jpg">
        <h1>Carrot</h1>
        <?php if($sale == "Yes"){
        ...
        ?>
        <p>Aisle: <?php echo $aisle?><br>In Stock:<?php echo $qty?><br>Sourced from American Farms</p>
        <button onclick="moreDesc()" class="button button1">More Description</button>
        <div id="moreDesc" style="display: none">
          Farm: Biggie Farm<br>Imported From: Texas, USA <br>Expires: 04/13/21<br>Average Length: 8cm<br>Product Number: <?php echo $product_id?><br>Organic (Non-GMO)
          <br>Calories: 90
        </div>
        <div class="button">
        <form method="POST" action="addToCart.php">
          <input style='display:none' name='name' value='Carrot' readonly>
          <input style='display:none' name='id' value='#6' readonly>
          ...
          <br>
          <button onclick="addToCart('Carrot(s)')" class="button button2">Add To Cart</button>
          </form>
        </div>
      </div>
