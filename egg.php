<?php $page_title='Eggs'; include('header.php');
$product_id='#14';
include('product_info.php');
?>
      <br><br>
      <div class ="item-description">
        <img src="images/egg-product.jpg">
        <h1>Egg</h1>
        <?php if($sale == "Yes"){
        ...
        <div id="moreDesc" style="display: none">
          Farm: Egg Farm<br>Imported From: Montreal, Quebec<br>Expires: 03/15/21<br>Amount per Carton: 6<br>Product Number: <?php echo $product_id?><br>Eggs from: Chicken
          <br>No added preservatives<br>Keep Refrigerated<br>Calories: 100
        </div>
        <div class="button">
        <form method="POST" action="addToCart.php">
          <input style='display:none' name='name' value='Egg' readonly>
          <input style='display:none' name='id' value='#14' readonly>
          ...
          <br>
          <button onclick="addToCart('Egg(s)')" class="button button2">Add To Cart</button>
          </form>
        </div>
      </div>
