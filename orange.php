<?php $page_title='Orange'; include('header.php');
$product_id='#1';
include('product_info.php');
?>
      <br><br>
      <div class ="item-description">
        <img src="images/orange-product.jpg">
        <h1>Orange</h1>
        <?php if($sale == "Yes"){
        ...
        ?>
        <p>Aisle: <?php echo $aisle?><br>In Stock:<?php echo $qty?><br>Different from mandarins<br>Comes in packs of 10</p>
        <button onclick="moreDesc()" class="button button1">More Description</button>
        <div id="moreDesc" style="display: none">
          Farm: Mufat Farm<br>Imported From: Toronto, Ontario<br>Expires: 03/20/21<br>Average Size: 3cm<br>Product Number: <?php echo $product_id?><br>Genetically Modified (GMO)
          <br>Calories: 150
        </div>
        <div class="button">
        <form method="POST" action="addToCart.php">
          <input style='display:none' name='name' value='Orange' readonly>
          <input style='display:none' name='id' value='#1' readonly>
          ...
          <br>
          <button onclick="addToCart('orange(s)')" class="button button2">Add To Cart</button>
          </form>
        </div>
      </div>
